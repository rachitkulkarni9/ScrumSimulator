...
public class NewSprintForm extends JFrame implements BaseComponent {
  ...
  public void init() {
    ...
    myJpanel.add(
        userStoriesLabel,
        new CustomConstraints(0, 3, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL));
    myJpanel.add(
        usList,
        new CustomConstraints(1, 3, GridBagConstraints.WEST, 1.0, 0.0, GridBagConstraints.NONE));
